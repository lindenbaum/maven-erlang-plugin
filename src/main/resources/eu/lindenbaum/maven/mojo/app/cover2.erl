...
%% compile_beam(Source) -> Result | {error,Reason}
%%   Source - see compile_beam/2
%%   Result - see compile/1
...
compile_beams([File | Files], Result, Options) ->
    R = compile_beam(File, Options),
    compile_beams(Files, [R | Result], Options);
compile_beams([], Result, _Options) ->
    reverse(Result).
