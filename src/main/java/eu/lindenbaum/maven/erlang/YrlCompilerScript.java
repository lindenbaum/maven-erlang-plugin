...
public class YrlCompilerScript extends AbstractScript<CompilerResult> {
  private final List<File> yrlFiles;
  private final File outDir;

  public YrlCompilerScript(List<File> yrlFiles, File outDir) throws MojoExecutionException {
    super();
    this.yrlFiles = yrlFiles;
    this.outDir = outDir;
  }
  ...
  public String get() {
    ...
    String files = ErlUtils.toFilenameList(this.yrlFiles, "\"", "\"");
